...
if "." in args.user:
        ...
        if user:
                ...
                exit();
print(args)
subprocess_call="grep -a "+args.user+" /usr/local/cpanel/logs/access_log"
...
progress=0
if not county:
    print(pink+"No results found!Try Manually"+reset);
    quit();
while True:
  ...
  #skipping our IP's
  if line and line.split()[0] not in ["115.110.127.198","122.15.255.69","115.110.71.146","182.73.214.22","111.93.159.50","220.227.162.29","124.79.131.170","182.74.165.114"]:
  	array2.append(line)
  if not line:
    break
keywords={
...
print(pink+"\nThe above details are parsed from cpanel logs. If you find the information to be incomplete or invalid , please contact HPS "+reset)
